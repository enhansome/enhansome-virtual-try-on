...
* [ControlNet](https://github.com/lllyasviel/ControlNet) ⭐ 34,110 | 🐛 460 | 🌐 Python | 📅 2024-02-25 - Hint: Use the clothing image as the image input and provide the human description in the text prompt or vice versa.
...
* [ThreeStudio](https://github.com/threestudio-project/threestudio) ⭐ 7,063 | 🐛 193 | 🌐 Jupyter Notebook | 📅 2024-12-16 - Hint: Use different models for generating output from the image-conditioned text prompts for fashion image editing.
...
* StableVITON: Learning Semantic Correspondence with Latent Diffusion Model for Virtual Try-On - [Project](https://rlawjdghek.github.io/StableVITON/), [Code/Data/Model](https://github.com/rlawjdghek/StableVITON) ⭐ 1,264 | 🐛 1 | 🌐 Python | 📅 2025-10-12
...
* CatVTON: Concatenation Is All You Need for Virtual Try-On with Diffusion Models - [Paper](https://arxiv.org/pdf/2407.15886), [Code](https://github.com/Zheng-Chong/CatVTON) ⭐ 1,834 | 🐛 71 | 🌐 Python | 📅 2025-12-16
...
* Real-time virtual try-on - [Demo](https://github.com/ZaiqiangWu/RTV) ⭐ 64 | 🐛 6 | 🌐 Python | 📅 2026-01-27
