...
* [ControlNet](https://github.com/lllyasviel/ControlNet) ⭐ 34,121 | 🐛 461 | 🌐 Python | 📅 2024-02-25 - Hint: Use the clothing image as the image input and provide the human description in the text prompt or vice versa.
...
* VITON-HD: High-Resolution Virtual Try-On via Misalignment-Aware Normalization - [Paper](https://arxiv.org/pdf/2103.16874.pdf), [Code/Model](https://github.com/shadow2496/VITON-HD) ⭐ 1,163 | 🐛 0 | 🌐 Python | 📅 2025-04-27
...
* OOTDiffusion: Outfitting Fusion based Latent Diffusion for Controllable Virtual Try-on - [Code](https://github.com/levihsu/OOTDiffusion) ⭐ 6,598 | 🐛 88 | 🌐 Python | 📅 2024-05-13
* CatVTON: Concatenation Is All You Need for Virtual Try-On with Diffusion Models - [Paper](https://arxiv.org/pdf/2407.15886), [Code](https://github.com/Zheng-Chong/CatVTON) ⭐ 1,847 | 🐛 72 | 🌐 Python | 📅 2025-12-16
* Magic Clothing: Controllable Garment-Driven Image Synthesis - [Paper](https://arxiv.org/abs/2404.09512), [Code](https://github.com/ShineChen1024/MagicClothing) ⭐ 1,546 | 🐛 63 | 🌐 Python | 📅 2024-07-29
...
* Real-time virtual try-on - [Demo](https://github.com/ZaiqiangWu/RTV) ⭐ 68 | 🐛 6 | 🌐 Python | 📅 2026-01-27
